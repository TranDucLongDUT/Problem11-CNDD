...
public class Database extends SQLiteOpenHelper {
    ...
    public int addContact(ModelPerson contact){
    ...
    public ModelPerson getContact(int id){
        ...
        ModelPerson contact = new ModelPerson(Integer.parseInt(cursor.getString(0)),cursor.getString(1),cursor.getString(2),cursor.getString(3)
                ,cursor.getString(4),cursor.getString(5),cursor.getString(6));

        return contact;
    }

    public List<ModelPerson> getAllContacts(){

        List<ModelPerson> contactList = new ArrayList<ModelPerson>();
        ...
        if (cursor.moveToFirst()){
            do {
                ModelPerson contact = new ModelPerson();
    ...
    public int updateContact(ModelPerson contact){
    ...
    public void deleteContact(ModelPerson contact){
